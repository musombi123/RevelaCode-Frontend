...
export default function ProphecyEventsDashboard() {
  ...
  const filtered = useMemo(() => {
    return events.filter((e) => {
      return !location || location === "Global" || e?.location?.country === location;
    });
  }, [events, location]);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters */}
      <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm flex flex-wrap gap-3 items-center">
        <select
          value={location}
          onChange={(e) => {
